...
<header>
    ...
    <div class="UserInfo">
        ...
        <tr class="tableHead">
            ...
            <?php
            include 'conn.php';
            $Huseraname=mysqli_real_escape_string($mysqli,$_POST['HuserName']);
            $Huseraname=str_replace('_',' ',$Huseraname);
            $Hemail=mysqli_real_escape_string($mysqli,$_POST['Hemail']);
            $result = mysqli_query($mysqli, "SELECT * from orders WHERE username='$Huseraname' OR email='$Hemail'");
